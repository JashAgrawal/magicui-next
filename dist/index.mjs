...
var MagicUIService = class {
  ...
  async initialize(apiKey, config = {}) {
    ...
    this.geminiClient = new GoogleGenAI2({ apiKey });
...
function MagicUIProvider({ theme, projectPrd, apiKey, children }) {
  ...
  return /* @__PURE__ */ React.createElement(MagicUIContext.Provider, { value: contextValue }, children);
}
...
import React7, { useEffect as useEffect2, useState } from "react";
...
// src/components/magic-ui/MagicUIErrorBoundary.tsx
var MagicUIErrorBoundary = class extends React4.Component {
  constructor(props) {
    super(props);
    this.handleRetry = () => {
  ...
  render() {
    ...
    if (this.state.hasError) {
      if (this.props.fallback) {
        ...
        return /* @__PURE__ */ React4.createElement(FallbackComponent, { error: this.state.error, retry: this.handleRetry });
      }
      return /* @__PURE__ */ React4.createElement("div", { className: "p-4 border border-red-200 rounded-lg bg-red-50" }, /* @__PURE__ */ React4.createElement(Alert, { className: "border-red-200 bg-red-50" }, /* @__PURE__ */ React4.createElement(AlertTriangle, { className: "h-4 w-4 text-red-600" }), /* @__PURE__ */ React4.createElement(AlertDescription, { className: "text-red-800" }, /* @__PURE__ */ React4.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React4.createElement("p", { className: "font-medium" }, "Something went wrong with this MagicUI component"), /* @__PURE__ */ React4.createElement("p", { className: "text-sm text-red-600" }, ((_a = this.state.error) == null ? void 0 : _a.message) || "An unexpected error occurred"), /* @__PURE__ */ React4.createElement(
        Button,
        {
        ...
        /* @__PURE__ */ React4.createElement(RefreshCw, { className: "w-4 h-4 mr-2" }),
        "Try Again"
      )))));
    }
...
function LoadingSpinner({ size = "md", className }) {
  ...
  return /* @__PURE__ */ React5.createElement(
    ...
    /* @__PURE__ */ React5.createElement("span", { className: "sr-only" }, "Loading...")
  );
}
function LoadingOverlay({ children, isLoading }) {
  return /* @__PURE__ */ React5.createElement("div", { className: "relative" }, children, isLoading && /* @__PURE__ */ React5.createElement("div", { className: "absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center z-10" }, /* @__PURE__ */ React5.createElement("div", { className: "flex flex-col items-center space-y-2" }, /* @__PURE__ */ React5.createElement(LoadingSpinner, { size: "lg" }), /* @__PURE__ */ React5.createElement("p", { className: "text-sm text-gray-600 font-medium" }, "Generating UI..."))));
}
...
function RegenerateButton({
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    isGenerating ? /* @__PURE__ */ React6.createElement(React6.Fragment, null, /* @__PURE__ */ React6.createElement(LoadingSpinner, { size: "sm", className: "mr-2" }), "Regenerating...") : /* @__PURE__ */ React6.createElement(React6.Fragment, null, /* @__PURE__ */ React6.createElement(RefreshCw2, { className: "w-4 h-4 mr-2" }), "Regenerate")
  );
}
...
function MagicUI({
  ...
  const generateUI = React7.useCallback(async (forceRegenerate = false) => {
  ...
  const handleRegenerate = React7.useCallback(() => {
    generateUI(true);
  }, [generateUI]);
  useEffect2(() => {
    if (hasRequiredData) {
  ...
  if (componentError || moduleError) {
    return /* @__PURE__ */ React7.createElement("div", { className: cn("relative", className) }, /* @__PURE__ */ React7.createElement("div", { className: "p-4 border border-red-200 rounded-lg bg-red-50" }, /* @__PURE__ */ React7.createElement("p", { className: "text-red-800 font-medium" }, "Failed to generate UI component"), /* @__PURE__ */ React7.createElement("p", { className: "text-red-600 text-sm mt-1" }, componentError || moduleError)), /* @__PURE__ */ React7.createElement(
      RegenerateButton,
      {
  ...
  return /* @__PURE__ */ React7.createElement("div", { className: cn("relative", className) }, /* @__PURE__ */ React7.createElement(MagicUIErrorBoundary, null, /* @__PURE__ */ React7.createElement(LoadingOverlay, { isLoading: isGenerating }, generatedComponent ? React7.createElement(generatedComponent, {
    data,
    className: "magic-ui-generated-component"
  }) : /* @__PURE__ */ React7.createElement("div", { className: "p-8 border border-gray-200 rounded-lg bg-gray-50 text-center" }, /* @__PURE__ */ React7.createElement("p", { className: "text-gray-600" }, "Generating UI component...")))), /* @__PURE__ */ React7.createElement(
    RegenerateButton,
    {
      onRegenerate: handleRegenerate,
      isGenerating
...
function createComponentFromCode(code, moduleName) {
  try {
    return function GeneratedComponent({ data, className }) {
      ...
      `;
      return /* @__PURE__ */ React7.createElement("div", { className: cn("w-full h-full", className) }, /* @__PURE__ */ React7.createElement("div", { className: "flex items-center justify-between mb-2" }, /* @__PURE__ */ React7.createElement("h3", { className: "text-sm font-medium text-gray-700" }, moduleName)), /* @__PURE__ */ React7.createElement("div", { className: "relative border rounded-lg overflow-hidden bg-white shadow-sm" }, /* @__PURE__ */ React7.createElement(
        "iframe",
        {
      ...
      )), /* @__PURE__ */ React7.createElement("div", { className: "mt-2 text-xs text-gray-500" }, /* @__PURE__ */ React7.createElement("p", null, "Preview of generated UI component")));
    };
  } catch (error) {
    console.error("Failed to create component from code:", error);
    return function ErrorComponent({ data }) {
      return /* @__PURE__ */ React7.createElement("div", { className: "p-4 border border-red-200 rounded-lg bg-red-50" }, /* @__PURE__ */ React7.createElement("p", { className: "text-red-800 font-medium" }, "Failed to render generated component"), /* @__PURE__ */ React7.createElement("p", { className: "text-red-600 text-sm mt-1" }, "Module: ", moduleName));
    };
  }
}
...
function MagicUIProvider2({ theme, projectPrd, apiKey, children }) {
  ...
  return /* @__PURE__ */ React8.createElement(MagicUIProvider, { theme, projectPrd, apiKey }, children);
}
...
function MagicUIPage({
  ...
  const actions = useMagicUIActions();
  const [generatedComponent, setGeneratedComponent] = useState2(null);
  const [componentError, setComponentError] = useState2(null);
  const hasRequiredData = isInitialized && geminiClient;
  const generateUI = React9.useCallback(async (forceRegenerate = false) => {
    if (!isInitialized || !geminiClient) {
  ...
  const handleRegenerate = React9.useCallback(() => {
    generateUI(true);
  }, [generateUI]);
  useEffect3(() => {
    if (hasRequiredData) {
  ...
  if (!isInitialized || !hasRequiredData) {
    return /* @__PURE__ */ React9.createElement("div", { className: cn("min-h-screen p-4 bg-gray-50", className) }, /* @__PURE__ */ React9.createElement("p", { className: "text-gray-600 text-center" }, "Initializing MagicUIPage..."));
  }
  if (componentError || moduleError) {
    return /* @__PURE__ */ React9.createElement("div", { className: cn("min-h-screen relative", className) }, /* @__PURE__ */ React9.createElement("div", { className: "p-4 border border-red-200 rounded-lg bg-red-50 m-4" }, /* @__PURE__ */ React9.createElement("p", { className: "text-red-800 font-medium" }, "Failed to generate full page UI"), /* @__PURE__ */ React9.createElement("p", { className: "text-red-600 text-sm mt-1" }, componentError || moduleError)), /* @__PURE__ */ React9.createElement(
      RegenerateButton,
      {
        onRegenerate: handleRegenerate,
        isGenerating
  ...
  return /* @__PURE__ */ React9.createElement("div", { className: cn("min-h-screen relative", className) }, /* @__PURE__ */ React9.createElement(MagicUIErrorBoundary, null, /* @__PURE__ */ React9.createElement(LoadingOverlay, { isLoading: isGenerating }, generatedComponent ? React9.createElement(generatedComponent, {
    data,
    className: "magic-ui-generated-page"
  }) : /* @__PURE__ */ React9.createElement("div", { className: "min-h-screen flex items-center justify-center bg-gray-50" }, /* @__PURE__ */ React9.createElement("p", { className: "text-gray-600" }, "Generating full page UI...")))), /* @__PURE__ */ React9.createElement(
    RegenerateButton,
    {
      onRegenerate: handleRegenerate,
      isGenerating
...
function createComponentFromCode2(code, moduleName) {
  try {
    return function GeneratedPageComponent({ data, className }) {
      ...
      `;
      return /* @__PURE__ */ React9.createElement("div", { className: cn("w-full min-h-screen", className) }, /* @__PURE__ */ React9.createElement(
        "iframe",
        {
          srcDoc: iframeContent,
    ...
    return function ErrorComponent({ data }) {
      return /* @__PURE__ */ React9.createElement("div", { className: "min-h-screen flex items-center justify-center bg-red-50" }, /* @__PURE__ */ React9.createElement("div", { className: "p-4 border border-red-200 rounded-lg" }, /* @__PURE__ */ React9.createElement("p", { className: "text-red-800 font-medium" }, "Failed to render generated page"), /* @__PURE__ */ React9.createElement("p", { className: "text-red-600 text-sm mt-1" }, "Module: ", moduleName)));
    };
  }
}
var MagicUIPage_default = MagicUIPage;
export {
  MagicUI_default as MagicUI,
  MagicUIPage_default as MagicUIPage,
  MagicUIProvider_default as MagicUIProvider
};
