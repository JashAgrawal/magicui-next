...
const prefilled = {
  prd: "A modern product showcase for an eco-friendly e-commerce platform. Focus on sustainability, clean design, and user engagement. Include environmental impact metrics and green certifications.",
  description:
    "Create a beautiful product card showcasing name ({{name}}), price (${{price}}), eco-rating ({{ecoRating}}), image ({{image}}), and sustainability features ({{features}}). Use fallback image https://placehold.co/400x300/10b981/ffffff?text=Eco+Product if main image fails.",
  data: JSON.stringify(
    {
...
export default function AwesomePlaygroundPage() {
  ...
  const generateDemo = () => {
    ...
    setTimeout(() => setIsGenerating(false), 1500) // Simulate generation
  }
        ...
        <main className="lg:col-span-3 space-y-6">
          ...
          <div className="flex justify-center">
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white px-8 py-4 rounded-2xl shadow-xl transition-all hover:scale-105 disabled:opacity-50"
            >
              {isGenerating ? (
                <>
